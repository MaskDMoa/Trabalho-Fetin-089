...
O ambiente depende da criação de um SIEM Wazuh local usando containers.
...
- 📄 **Análise em Tempo Real:** Escaneamento ininterrupto do arquivo de log de alertas (`alerts.json`).
- 🚫 **Ações Defensivas Automáticas:** Bloqueios ativos (como banimento de IP) caso se depare com alertas críticos predefinidos.
- 📝 **Auditoria:** Registro formal de todas as medidas e incidentes contidos para análise pericial futura.
